...
# Format is <URL>: [<Title>, <HTML Description>, <Units for Chart>]
# For charts with multiple lines, the Units can be an array instead of a string
chart_page_content = {
