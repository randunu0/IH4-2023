...
chart_page_content = {
    ...
    "solar": ["Solar Power Generation", "Solar Power Generation displays the system-wide solar power production. This data is updated every hour. Solar Power Generation depends on four factors, namely: sun intensity, cloud cover, module temperature, and humidity. Most solar energy is collected when the sun is at its peak, which is usually midday. When it is a cloudy day, there is a decrease in power generation, because the cloud reflects some of the sun’s rays and limits the amount of sun absorption by the solar panels. However, solar cells work best at low temperatures so when the temperature is at its highest, typically during the summer, the heat causes the semiconductor properties to shift, which results in the panel’s performance reduction. Another factor is humidity because it can reduce solar power output by reflecting or refracting the sunlight away from solar cells, which reduces the amount of sunlight that hits the panels. When humidity penetrates the solar panel, it can also degrade the solar panel itself. Sources: https://www.sciencedirect.com/science/article/pii/S1364032111000256?casa_token=niTg6lWrHLcAAAAA:isUFaywvmhSpvOFR7PzvymGpu_CIiT7qyNA92qunCQKjl1T1U6ncgOvPc9DnWINXO3rgx-6UTrES https://www.renewablegreenenergypower.com/solar-energy/solar-panel-efficiency Fun Fact: The ERCOT system had a record solar generation of 7,036 MW on August 3, 2021. Source: https://www.ercot.com/files/docs/2021/12/30/ERCOT_Fact_Sheet.pdf", "Generation in MW (SPP)"],
    "wind": ["Wind Power Generation", "Wind displays the system-wide wind power production. This data is updated every hour. Wind power generation in an area depends on three factors: wind speed, air density, and weather temperature. A wind turbine is usually shut down when the wind speed is either below or above the cut-in values. When the wind speed is above the cut-in value, the wind turbine extracts the maximum amount of power. However, the relationship between wind speed and output power is not linearly proportional. Meanwhile, the energy produced by the wind is directly proportional to air density. The higher the air density, the larger the amount of power extracted from the wind turbines. Wind power generation is inversely proportional to temperature. The lower the weather temperature the larger the output power from the wind turbines. Source: https://ieeexplore.ieee.org/document/8301377 Fun Fact: The ERCOT system had a record wind generation of 24,681 MW on December 23, 2021. Source: https://www.ercot.com/files/docs/2021/12/30/ERCOT_Fact_Sheet.pdf", "Generation in MW (WPP)"],         
